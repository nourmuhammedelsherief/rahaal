...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('TruckType')}}">أنواع الشاحنات </a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>عرض أنواع الشاحنات</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">عرض أنواع الشاحنات
        <small>عرض جميع أنواع الشاحنات  </small>
    </h1>
@endsection
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            ...
                                            {{--</li>--}}
                                            <li>
                                                <a href="{{route('editTruckType' , $truck->id)}}">
                                                    <i class="icon-docs"></i> تعديل </a>
                                            </li>
                                            {{--                                            @if( auth()->user()->id != $value->id )--}}
                                            <li>
                                                <a class="delete_user" data="{{ $truck->id }}" data_name="{{ $truck->ar_name }}" >
