...
@section('page_header')
    ...
    <h1 class="page-title">عرض ماركة الشاحنات
        <small>عرض جميع ماركة الشاحنات  </small>
    </h1>
@endsection
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            ...
                                            {{--</li>--}}
                                            <li>
                                                <a href="{{route('editVehicleBrand' , $brand->id)}}">
                                                    <i class="icon-docs"></i> تعديل </a>
                                            </li>
                                            {{--                                            @if( auth()->user()->id != $value->id )--}}
                                            <li>
                                                <a class="delete_user" data="{{ $brand->id }}" data_name="{{ $brand->ar_name }}" >
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_user', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/vehicle_brands/delete/"+id;
