                                    ...
                                    <div class="form-horizontal" role="form">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="ar_name" class="form-control" placeholder="أسم الدولة بالعربي" value="{{$country->ar_name}}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="en_name" class="form-control" placeholder="أسم الدولة بالأنجليزي " value="{{$country->en_name}}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="ur_name" class="form-control" placeholder="أسم الدولة بالأوردو " value="{{$country->ur_name}}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="code" class="form-control" placeholder="كود الدولة" value="{{$country->code}}" required>
                                                    @if ($errors->has('code'))
                                                        <span class="help-block">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="ar_currency" class="form-control" placeholder="عملة الدولة بالعربي" value="{{$country->ar_currency}}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="en_currency" class="form-control" placeholder="عملة الدولة بالأنجليزي" value="{{$country->en_currency}}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="ur_currency" class="form-control" placeholder="عملة الدولة بالأردو" value="{{$country->ur_currency}}" required>
